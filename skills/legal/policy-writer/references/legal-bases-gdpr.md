> Provenance: copied from privacy-policy-malik-taiar/references/BASES_LEGALES.md (AGPL-3.0, author Malik Taiar) on 2026-07-05. Content in French - the six GDPR Art 6 lawful bases in depth, each with validity conditions, examples, and ready policy wording, plus the legitimate-interest assessment test.
> Read when: assigning a lawful basis to each processing purpose (the purposes/legal-basis table of a privacy policy or DPA annex).
> Pair with jurisdictions-eu-uk.md for the English-language Art 13/14 disclosure checklist.
> Verified: 2026-07-09 against live sources (Art 6/7 doctrine; 10-year invoice retention, art. L123-22 Code de commerce, https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000006219327/; 1-year connection-log retention, LCEN art. 6 + decret 2021-1362, https://www.legifrance.gouv.fr/jorf/id/JORFTEXT000044228912). Re-verify if older than 12 months.

# Bases Légales du Traitement

> Référence : Article 6 du RGPD
>
> **Documentation** : [RGPD_texte_officiel.pdf](assets/sources/RGPD_texte_officiel.pdf), [CNIL_principes_rgpd.pdf](assets/sources/CNIL_principes_rgpd.pdf), [CNIL_finalites.pdf](assets/sources/CNIL_finalites.pdf)
